...
#WORKING WITH IMAGES
import cv2
img = cv2.imread('D:\\SPINAL LESION\\SpinalLesion j\\Vindr dataset j - Copy DT - Copy\\Cropped Dataset Vindr\\TRAIN-CR\\No Finding\\0cf7d54cc1c37057c8d1e5d1a0d7465f.jpg')
img.shape
plt.imshow(img)
...
#plot histogram
b = plt.hist(img.flatten(),bins=255)
